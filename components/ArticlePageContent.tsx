        ...
        <div className="article-layout">
          ...
          <aside className="sidebar">
            ...
            >
              ...
              >
                Get business insights every morning
              </h3>
              <p
                style={{
                  fontSize: "13px",
              ...
              >
                Join 50,000+ business leaders. Free. No spam.
              </p>
              <form
              ...
              >
                ...
                />
                <button type="submit" className="btn-subscribe" style={{ justifyContent: "center" }}>
                  Subscribe Free
                </button>
              </form>
            </div>
            ...
            {/* Vertical info */}
            <div className="sidebar-widget">
              <div className="sidebar-widget-title">{vertical.name}</div>
              <p
                style={{
                  fontSize: "14px",
                  color: "var(--color-text-muted)",
